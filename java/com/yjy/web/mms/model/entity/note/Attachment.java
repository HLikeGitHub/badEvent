...
public class Attachment {
	...
	private ProcessList process;//对应公务接待
	...
	@Column(name="attachment_allpath")
	private String attachmentAllpath;  //附件存储路径
	
	public String getAttachmentAllpath() {
		return attachmentAllpath;
	}

	public void setAttachmentAllpath(String attachmentAllpath) {
		this.attachmentAllpath = attachmentAllpath;
	}
	...
	public Attachment(Long attachmentId, String attachmentName, String attachmentPath, long attachmentSize,
			String attachmentType, Date uploadTime, String model, String attachmentShuffix, ProcessList processList) {
		super();
		this.attachmentId = attachmentId;
		this.attachmentName = attachmentName;
		this.attachmentPath = attachmentPath;
