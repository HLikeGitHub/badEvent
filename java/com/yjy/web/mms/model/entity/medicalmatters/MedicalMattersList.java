...
@Entity
@Table(name="aoa_medical_matters")
//主表
public class MedicalMattersList{
	
	@Id
	@Column(name="medicalmatters_id")
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	private Long medicalmattersId;
	...
	public Long getMedicalmattersId() {
		return medicalmattersId;
	}

	public void setMedicalmattersId(Long medicalmattersId) {
