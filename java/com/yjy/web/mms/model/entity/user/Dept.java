...
//	private Date endTime;		//部门下班时间
	@Column(name = "zgyzuser_name")
	private String zgyzuserName;	//科室主管院长
	
	@Column(name = "lcks")
	private String lcks = "";	//是否为临床科室
	
	
	public String getLcks() {
		return lcks;
	}

	public void setLcks(String lcks) {
		this.lcks = lcks;
	}

	public String getZgyzuserName() {
		return zgyzuserName;
	}

	public void setZgyzuserName(String zgyzuserName) {
		this.zgyzuserName = zgyzuserName;
	}
