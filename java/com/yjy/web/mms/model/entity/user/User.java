package com.yjy.web.mms.model.entity.user;
...
public class User {
	...
	@Column(name="is_hys")
	private Integer is_hys=0;		//是否会议室管理员

	@Column(name="ryzb")
	private String ryzb;	//人员所属组别

	@Column(name="limit_date")
	private Date limitDate;	//限制日期
	...
	public String getRyzb() {
		return ryzb;
	}

	public void setRyzb(String ryzb) {
		this.ryzb = ryzb;
	}

	public Integer getIs_hys() {
		return is_hys;
	}

	public void setIs_hys(Integer is_hys) {
		this.is_hys = is_hys;
	}
