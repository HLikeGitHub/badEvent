...
public interface MedicalMattersReviewedDao extends PagingAndSortingRepository<MedicalMattersReviewed, Long>{
...
//	Reviewed findByProIdAndUserId(Long pro,User u);
	...
	@Query(" select re from MedicalMattersReviewed as re where re.medicalmattersId.medicalmattersId=?1 ")
	List<MedicalMattersReviewed> findByMedicalmattersId(Long mmpro);
}
