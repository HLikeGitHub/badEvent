...
import com.yjy.web.mms.model.entity.role.Rolepowerlist;
import org.springframework.data.jpa.repository.JpaRepository;
import org.springframework.data.jpa.repository.Query;

public interface RolepowerlistDao extends JpaRepository<Rolepowerlist, Long>{
	//找所有的父菜单
	@Query("select distinct new com.yjy.web.mms.model.entity.role.Rolemenu(menu.menuId,menu.menuName,menu.menuUrl,menu.show,role.check,menu.parentId,menu.menuIcon,menu.sortId,menu.menuGrade) "
	...
	@Query("select po from Rolepowerlist as po where po.roleId.roleId=?1 and po.menuId.menuId=?2")
	List<Rolepowerlist> findbyroleidandmenuid_winper(Long roleid, Long menuid);
		//找所有可显示的父菜单
		@Query("select new com.yjy.web.mms.model.entity.role.Rolemenu(menu.menuId,menu.menuName,menu.menuUrl,menu.show,role.check,menu.parentId,menu.menuIcon,menu.sortId,menu.menuGrade) "
				+ "from Rolepowerlist as role,SystemMenu as menu where role.menuId.menuId=menu.menuId "
		...
		//根据role_id查找所有rolepowerlist
		@Query("from Rolepowerlist rp where rp.roleId.roleId=?1")
