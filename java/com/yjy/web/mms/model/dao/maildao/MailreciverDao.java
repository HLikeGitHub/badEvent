package com.yjy.web.mms.model.dao.maildao;
...
public interface MailreciverDao extends PagingAndSortingRepository<Mailreciver, Long>{
	...
	//收件箱查询
	@Query("select new com.yjy.web.mms.model.entity.mail.Pagemail(list.mailId,list.mailType,list.mailStatusid,list.mailTitle,list.inReceiver,list.mailFileid.attachmentId,list.mailCreateTime,mr.star,mr.read) "
