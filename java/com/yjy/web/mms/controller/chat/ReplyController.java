package com.yjy.web.mms.controller.chat;

import com.yjy.web.mms.model.dao.discuss.*;
import com.yjy.web.mms.model.dao.user.UserDao;
import com.yjy.web.mms.model.entity.discuss.*;
import com.yjy.web.mms.model.entity.user.User;
import com.yjy.web.mms.services.discuss.CommentService;
import com.yjy.web.mms.services.discuss.DiscussService;
import com.yjy.web.mms.services.discuss.ReplyService;
import com.yjy.web.mms.services.discuss.VoteService;
...
public class ReplyController {
	...
	public String reply(HttpServletRequest req,
		...
		if("discuss".equals(module)){
			dis=discussDao.getOne(discussId);
			num=dis.getDiscussId();
		}else{
			Reply replyyy=replyDao.getOne(discussId);
...
//		}
	...
	private void likeThisFun(HttpServletRequest req, Long userId) {
		...
		User user=uDao.getOne(userId);
		if("discuss".equals(module)){
			Discuss discuss=discussDao.getOne(replyId);
	...
	public String voteHandle(HttpServletRequest req,@SessionAttribute("userId") Long userId,Model model){
		...
		Discuss discuss=discussDao.getOne(discussId);
		User user=uDao.getOne(userId);
		VoteTitles voteTitle=voteTitleDao.getOne(titleId);
