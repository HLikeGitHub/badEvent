package com.yjy.web.mms.controller.plan;
...
import com.yjy.web.mms.controller.attendce.AttendceController;
import com.yjy.web.mms.model.dao.notedao.AttachmentDao;
import com.yjy.web.mms.model.dao.plandao.PlanDao;
import com.yjy.web.mms.model.dao.plandao.Planservice;
...
public class PlanController {
	...
	public String DSAGec(HttpServletRequest request, HttpSession session) {
		...
		long userid = planDao.getOne(pid).getUser().getUserId();
	...
	public String test23(HttpServletRequest request, Model model, HttpSession session, 
		...
		Plan plan = planDao.getOne(Long.valueOf(pid));
