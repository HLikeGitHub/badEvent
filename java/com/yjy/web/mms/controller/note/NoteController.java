package com.yjy.web.mms.controller.note;
...
import com.yjy.web.mms.model.dao.notedao.*;
...
import com.yjy.web.mms.model.entity.note.Catalog;
import com.yjy.web.mms.model.entity.note.Note;
import com.yjy.web.mms.model.entity.note.Noteuser;
...
public class NoteController {
	...
	@Autowired
	private com.yjy.web.mms.model.dao.notedao.NoteService NoteService;
	@Autowired
...
// post请求 添加类型
	...
	public String test3(@Param("id") String id, HttpServletRequest Request, HttpServletResponse response,
		...
		Note note = noteDao.getOne(nid);
		User user = userDao.getOne(note.getCreatemanId());
		if (note.getAttachId() != null) {
	...
	public String test4(HttpServletRequest Request, HttpSession session,Model model,
		...
		if(cataloglist.size()==0)
			cataloglist.add(catalogDao.findById(33l).orElse(null));
		else
		cataloglist.set(0, catalogDao.findById(33l).orElse(null));
		...
		if (nId.contains("cata")) {
			...
			Catalog cate = catalogDao.findById(ca).orElse(null);
